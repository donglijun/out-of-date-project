<?php
class Redis_Gold_Ranking_Site_User_BaseModel extends Redis_BaseModel
{
    protected $pattern = '';
    ...
    {
        return sprintf('gold.site.user.ranking:%s', date($this->pattern, $timestamp ?: time()));
    }

    public function incr($user, $val = 1, $timestamp = null)
    {
        $result = false;
