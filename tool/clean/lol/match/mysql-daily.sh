...
REQUEST_URI_CLEANUP_MYSQL_LOL_MATCH="/cron/cleanup/mysqllolmatch/day/21"

PLATFORMS="wt1 oc1 ru la1 la2 na1 br1 tr1 eun1 euw1 kr"

## Run
for platform in $PLATFORMS; do
    $PHP_BIN $PHP_SCRIPT_CLI request_uri="$REQUEST_URI_CLEANUP_MYSQL_LOL_MATCH"/platform/"$platform"
done
